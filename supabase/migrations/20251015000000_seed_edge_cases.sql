...
insert into public.products (id, title, price, condition, created_at) values
  ...
  ('5e545fb7-31f6-4e46-896b-914d8609de92', 'MacBook Pro 14 (2023)', 1999.00, 'Used - Excellent', '2025-01-10 09:00:00'),
  ('730213ee-6136-424a-843e-53e36a5c0e11', 'MacBook Pro 14 (2023)', 2050.00, 'Used - Excellent', '2025-02-01 10:00:00'),
  ('bd1c7a02-1950-44aa-8856-4c49b79a13ab', 'MacBook Pro 14 (2023)', 1999.00, 'Used - Good', '2025-02-01 12:00:00'),
  ('4aa754c0-56b2-4406-9958-287b985aef1d', 'Vintage Camera Collection (Lot of 5)', 0, 'Collectible', '2025-02-02 09:30:00'),
  ...
  ('db77adad-fb92-481f-9e34-9af8b5525edd', 'Noise-Cancelling Earbuds (Gen-I) - Midnight/Icmega', 279.99, 'New', '2025-02-06 09:05:00');

insert into public.users (id, name, email, full_name, created_at) values
  ('145e3cc0-9bbd-4226-a7f2-482499d29387', 'Ali Miro', 'ali@example.com', 'Ali Miro', '2025-10-15 12:56:22.477464'),
  ('2e396caf-f08b-4329-a8a1-8c25645cf8c0', 'Sara Jalal', 'sara@example.com', 'Sara Jalal', '2025-10-15 12:56:22.477464'),
  ('9e4bc215-6513-4446-b727-bcdfe087b5f1', 'Omar Rahman', 'omar@example.com', 'Omar Rahman', '2025-10-15 12:56:22.477464'),
  ('829fc4cb-ea3a-42b0-818b-cc9f15d6d74a', 'Layla Aziz', 'layla.aziz@example.com', 'Layla "Lulu" Aziz', '2025-10-15 13:11:51.303443'),
  ('47198338-6069-465b-9a7e-44cc7d9a994c', 'Dr. Nihad Farouq', 'nihad@example.com', 'Dr. Nihad Farouq', '2025-10-15 13:11:51.303443'),
  ('0e8c61e8-966a-44cf-a095-eb34d58183fd', 'Zara Al-Hassan', 'zara@example.com', 'Zara Al-Hassan', '2025-10-15 13:11:51.303443');
