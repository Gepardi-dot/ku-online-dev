...
import { Heart, Home, MessageSquare, PackagePlus, User } from "lucide-react";
...
const NAV_ITEMS: NavItem[] = [
  ...
  { key: "favorites", href: "/products", labelKey: "nav.products", icon: Heart },
            ...
            return (
              ...
              >
                <FavoritesMenu
                  ...
                  compactTrigger
                  triggerClassName="text-muted-foreground hover:text-foreground h-(--nav-icon-size) w-(--nav-icon-size) p-0"
                  triggerIcon={<Heart className="h-full w-full" strokeWidth={2} />}
                />
                <span dir="auto" className={cn("bidi-auto", labelClassName)}>
                  {t(item.labelKey)}
                </span>
