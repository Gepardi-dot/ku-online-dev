  ...
  return (
    ...
    >
      ...
      <DropdownMenuContent
        align="end"
        sideOffset={10}
        className="z-[90] w-48 rounded-[32px] border border-white/60 bg-gradient-to-br from-white/30 via-white/20 to-white/5 !bg-transparent p-4 shadow-[0_18px_48px_rgba(15,23,42,0.22)] backdrop-blur-[50px] ring-1 ring-white/40"
      >
        ...
        {SUPPORTED_LANGUAGES.map((code) => (
          <DropdownMenuItem
            ...
            className="flex items-center justify-between gap-4 rounded-2xl border border-transparent bg-white/50 shadow-sm ring-1 ring-black/[0.03] px-3 py-2 mb-2 last:mb-0 hover:bg-white/60 hover:border-[#eadbc5]/50 cursor-pointer"
          >
