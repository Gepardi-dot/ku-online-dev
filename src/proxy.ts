...
export const config = {
  matcher: [
     ...
     * - manifest.webmanifest and service worker assets
     * Feel free to modify this pattern to include more paths.
     */
    '/((?!_next/static|_next/image|favicon.ico|manifest.webmanifest|offline\\.html|sw\\.js|workbox-[^/]+\\.js|.*\\.(?:svg|png|jpg|jpeg|gif|webp)$).*)',
  ],
};
